...
import { EventArgument, EventCallback } from "../events";
...
export interface InternalEventArgToMap {
...
export declare type EmbedCallbacks = EmbedOnActionEventCallback | EmbedPageLoadedCallback | EmbedProjectsViewModeChangedCallback | EmbedProjectsRegionChangedCallback | EmbedProjectCreatedEventCallback;
export {};
